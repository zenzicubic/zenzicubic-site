    ...
    */
    ...
    return (<>
        ...
        <Demo title="Dandelin spheres">
            <p>This is a demo of a modifiction of the <a href="https://en.wikipedia.org/wiki/Dandelin_spheres" target="_blank" rel="noopener noreferrer">Dandelin spheres</a>, a set of special spheres that provide a beautiful proof of the equivalence of two famous methods of constructing ellipses.</p>

            <Accordion title="What is this?">
                There are many methods to construct ellipses, but two of the most famous are cutting a cone by a plane and the <a href="https://en.wikipedia.org/wiki/Ellipse#Pins-and-string_method" target="_blank" rel="noopener noreferrer">pins-and-string method</a>. Essentially, if we draw two spheres (the Dandelin spheres) tangent to both the cylinder and the cutting plane at one of the foci, we can look at the relationships between the segments connecting points on circles of tangency to a point on the ellipse and the segments connecting the foci to that same point to prove the equivalence of these two methods. Congruent segments have the same color here. This technique is usually done with a cone rather than a cylinder, but I&apos;ve modified it to make things simpler.
            </Accordion>

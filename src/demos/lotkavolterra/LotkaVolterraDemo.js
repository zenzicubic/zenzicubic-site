    ...
    return (<>
        ...
        <Demo title="Lotka-Volterra model" canvasRef={canvasRef} onInitialize={initialize} 
            ...
            <Accordion title="What is this?">
                ...
                In these equations, <MathJax inline>{'\\(x\\)'}</MathJax> represents the relative population of prey and <MathJax inline>{'\\(y\\)'}</MathJax> represents the relative population of prey.<br /><br />

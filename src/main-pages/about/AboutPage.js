    ...
    return (
        <>
            ...
            <FrontPageLayout img={bgImg}>
                ...
                <p>
                    Hello. I&apos;m Zenzicubic, and I&apos;m a catboy VTuber. I use he/him pronouns. I make YouTube videos about my passions: mainly practical chemistry and math (with a focus on aesthetically pleasing concepts, especially in group theory, dynamical systems, fractals, and geometry), but also whatever happens to interest me at a given moment. I&apos;ve been on YouTube since 2020, and I&apos;ve been a VTuber since January 2021. I film experiments in my home chemistry lab, and make animated math videos and explainers &#224; la 3Blue1Brown.
                    I&apos;ve also made <a
                    ...
                    I enjoy programming, and the <Link to="/projects">projects</Link> page contains a healthy collection of online math and math-adjacent demos and articles that I&apos;ve been accumulating since April 2022. The <Link to="/gallery">gallery</Link> page contains many mathematical images that I&apos;ve made over time. In fact, almost everything on this website was made by me, from the stylesheets to the images and UI. If you&apos;re curious, the source code of this site is <a href="https://github.com/zenzicubic/zenzicubic-site" target="_blank" rel="noopener noreferrer">available</a> on my GitHub page. I&apos;ve built myself a custom VTuber setup in Unity, with several rooms and interactive elements, such as a working whiteboard, a greenhouse, and several monitors.
                    <br /><br />
                ...
                <ul>
                    ...
                    <li>I live on the East Coast of the US.</li>

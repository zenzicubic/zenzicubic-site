...
// 3x3 matrix (row-major) math. Mostly this is used in one or two demos; 
// rotations are performed using quaternions.

export class Mat3 {
    /**
     * Creates a new 3x3 matrix.
     * @param {Array.<Number>} a First row. 
     * @param {Array.<Number>} b Second row.
     * @param {Array.<Number>} c Third row.
     */
    constructor(a, b, c) {
        this.vals = [a, b, c];
    }
